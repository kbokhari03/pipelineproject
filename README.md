...
To install Bowtie2, run this shell command: conda install bioconda::bowtie2
The instructions to install spades: https://ablab.github.io/spades/installation.html
The instructions to install NCBI datasets: https://www.ncbi.nlm.nih.gov/datasets/docs/v2/command-line-tools/download-and-install/
The instructions to insall Kallisto: https://pachterlab.github.io/kallisto/download
